    ...
    <div className="contenido container">
      ...
      <div className="row my-3">
        <div className="col-12">
          ...
          <h2 className="titulo">{ejercicio.nombre}</h2>
        </div>
        ...
        <div className="col-lg-6 col-md-12 col-sm-12 col-12 t-m">
          <div className="my-2">Musculo principal: {ejercicio.musPrin}</div>
          <div className="my-2">Musculo secundario: {ejercicio.musSec}</div>
