      ...
      <div className="contenido container">
        <div className="row text-center">
          ...
          <div className="col-12 mt-3 row">
            <h2 className="titulo col-12">
              Unión <span className="tituloN">Perfecta</span>{" "}
            </h2>
            <div className="col-12 text-white">
              <p>
                Tu cuerpo es tu proyecto más importante, y cuidarlo requiere
                equilibrio. Entrenar sin una buena alimentación es avanzar a
                medias. Por eso, la unión de Gold’s Fit y Gold’s Nutrition es la
                combinación ideal: te permite trabajar tu físico de forma
                completa, desde el entrenamiento hasta la comida que lo impulsa.
                Con Gold’s Fit, entrenas con estructura, propósito y rutinas
                adaptadas a ti. Con Gold’s Nutrition, te alimentas con
                precisión, siguiendo un plan que se ajusta a tus objetivos y
                estilo de vida. Juntas, estas herramientas te ayudan a
                transformar tu cuerpo con inteligencia, sin improvisaciones ni
                fórmulas genéricas. Entrena bien. Come mejor. Evoluciona con
                propósito.
              </p>
            </div>
          </div>
