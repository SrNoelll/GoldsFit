        ...
        <div>
            <div className='container py-5'>
                <div className='row nosotros'>
                    ...
                    <div data-aos="fade-right" className='col-md-6 d-flex h-100 justify-content-center'>
                        <img className='w-50 ' src='/dieta.webp' alt="" />
                    </div>
                    <div className='contenedorTit col-6 p-3 h-100 text-white'  data-aos="fade-left"><p className='' >
