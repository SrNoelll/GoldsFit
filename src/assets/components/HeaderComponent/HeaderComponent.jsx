    ...
    <>
      <header className="container-fluid">
        <nav
          className={
            dieta
              ? "fonA navbar navbar-light py-2 fixed-top"
              : "navbar navbar-light bg-warning py-2 fixed-top"
          }
        >
          <div className="container d-flex justify-content-between align-items-center">
            <a className="navbar-brand" href="/">
              <img
                src={dieta ? "/logoNutri.webp" : "/GoldFitEs.webp"}
                alt="Logo"
              />
            </a>
            <button
            ...
            <div className="d-none d-lg-flex gap-4 align-items-center">
              <Link className="hen" to={"/entrenamiento"}>
                <CgGym size={20} /> Entrenamiento
              </Link>
              <Link className="hen" to={"/alimentacion"}>
                <TbMeat size={20} /> Nutrición
              </Link>
              <Link className="hen" to={"/nosotros"}>
                <LuDna size={20} /> Método Gold’s
              </Link>
